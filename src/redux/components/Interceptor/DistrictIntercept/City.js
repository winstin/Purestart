...
let City = React.createClass({
    ...
    render: function(){
        return (
                <div>
                    <select name={this.props.provinceName ? this.props.provinceName : "province"} style={this.style} onChange={this.provinceChange}>
                        <option key="-1" value="-1" data-index="-1">省</option>
                        {this.provinceOption()}
                    </select>
                    <select name={this.props.cityName ? this.props.cityName : "city"} style={this.style} onChange={this.cityChange} ref="city">
                        <option key="-1" value="-1" data-index="-1">市</option>
                        {this.state.city}
                    </select>
                    <select name={this.props.countyName ? this.props.countyName : "county"} style={{ margin: "0 3px",padding: "2px 6px",fontSize: "14px",width:'200px'}} ref="county">
                        <option key="-1" value="-1" data-index="-1">区、县</option>
                        {this.state.county}
                    </select>
                </div>
        );
