...
class Cfsetting extends Component {
	constructor(props) {
        super(props);
        this.state = {
            value : '1',
	...
	render(){
		  ...
		  return (
        	<div>
	           ...
	           <div>
	           		<Row>
	           			<div className='set' style={{paddingTop:'20px'}}>订单催付： 下单后</div>
	           			<div className="demo-ctl">
				            <Select placeholder="选择时间" onChange={this.onSelect.bind(this)} value={this.state.value}>
				                ...
				                <Option value="5">2小时</Option>
				            </Select>
				        </div>
				        <div className='set' style={{paddingTop:'20px'}}>对用户发送催付短信。</div>
	           		</Row>
	           </div>
	            <div>
	           		<Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(Cfsetting)
