...
import * as SendErrorOrderTableActions from '../../actions/SendErrorOrderTable'
import _ from 'lodash';
import Data from './data';
import PrintDialog from './PrintDialog'
class SendErrorOrderTable extends Component {
    constructor() {
        super();
    }
    ...
    render(){
        ...
        <div style={{height:"100%"}}>
            <div className="excep-buttons">
                <PrintDialog text = "重新发货" type = "primary" id = "print"/>
...
function mapStateToProps(state, ownProps){
    return {
        orderTotal:state.SendErrorOrderTable.orderTotal,
        isLoading:state.SendErrorOrderTable.isLoading,
        orderData:state.SendErrorOrderTable.orderData,
        selectCondition:state.SendErrorOrderTable.selectCondition,
        ItemsSelected_arr:state.SendErrorOrderTable.ItemsSelected_arr
    }
}

function mapDispatchToProps(dispatch,ownProps){
    return bindActionCreators(SendErrorOrderTableActions, dispatch)
}

export default connect(mapStateToProps, mapDispatchToProps)(SendErrorOrderTable)
