/**
 @author Mothpro
**/
export const WAIT_GET_ORDER_DATA = "WAIT_GET_ORDER_DATA"
...
export function getOrderData(condition){
    ...
    return (dispatch,getState)=>{
            let isLoading = getState().WaitPrintOrderTable.isLoading;
            //加载动画
            ...
            api("ebs.orderData.list",condition,function(e){
                ...
                let ItemsSelected_arr = e.result.map((c)=>{
                    ...
                    c.address = `${c.receiver_state} ${c.receiver_city} ${c.receiver_district} ${c.receiver_address}`
                    return false;
                });
